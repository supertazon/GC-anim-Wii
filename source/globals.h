...
//void initGraphics(f32* gH, f32* gV, f32* scaleGCy, f32* posyInit, f32* tv1, f32* tv2, f32* tv3); // Initializes GRRLIB, resolution and animation speed parameters depending on Wii's region and display settings
